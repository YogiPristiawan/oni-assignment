    ...
    <div class="app-card app-card-orders-table mb-5 border">
      <div class="app-card-body">
        <div class="p-4">
          ...
          <?php endif; ?>
          <form action="<?php echo e(route('users.update', ['userId' => $user->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yuu/Programming/ony-assignment/resources/views/user/edit.blade.php ENDPATH**/ ?>